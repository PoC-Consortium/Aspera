...
PoCC Aspera A Burstcoin Wallet - Terms and conditions
-----------------------------------------------------

1. **Preamble:** This Agreement governs the relationship between the operator of this software, (hereinafter: Licensee) and PoC Consortium, a partnership under the laws of whose principal place of business is Germany (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using PoCC Aspera back-end (hereinafter: The Software) created and owned by Licensor, as detailed herein

2. **Restricted Use:**

Use of The Software is granted to provide access to and interaction with the public ledger (blockchain) of the Burst cryptocurrency (BURST) network only. Licensee must adhere to the majority consensus of the Burstcoin network.

More specifically, it is prohibited to use The Software for any other blockchain whose tokens are traded on any exchange (public, restricted or private) under a different ticker symbol than BURST.

Licensee is allowed to use The Software on the public Burstcoin network (MainNet), the Burstcoin test network (TestNet) or a private version of the Burstcoin network running on and accessible from his local machine only (PrivNet).
