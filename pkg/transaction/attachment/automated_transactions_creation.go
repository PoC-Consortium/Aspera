...
*/
func (attachment *AutomatedTransactionsCreation) FromBytes(bs []byte, version uint8) (int, error) {
	...
	if attachment.NumName > maxAtNameLen {
		return 0, fmt.Errorf("at name too long")
	}
	...
	if attachment.NumDescription > maxAtDesriptionLen {
		return 0, fmt.Errorf("at description too long")
	}
